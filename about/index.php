    ...
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">I started ATC-COM because I thought the aviation sector wasn´t beginner friendly.
        	...
        	I want to help those in the aviation community with these tools so they can have a better experience and an easier way of undertanding the matter.</p>
      </div>
  ...
  <div class="container py-5">
    ...
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">The information provided by ATC-COM on https://atccom.de/ is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability or completeness of any information on the Site. UNDER NO CIRCUMSTANCE SHALL WE HAVE ANY LIABILITY TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF THE SITE OR RELIANCE ON ANY INFORMATION PROVIDED ON THE SITE. YOUR USE OF THE SITE AND YOUR RELIANCE ON ANY INFORMATION ON THE SITE IS SOLELY AT YOUR OWN RISK.</p><a href="https://atccom.de/privacy/" class="btn btn-light px-5 rounded-pill shadow-sm">Privacy Policy</a>
      </div>
