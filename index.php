<?php $page='home'; $title='ATC-Com'; include 'assets/layout/header.php'; ?>
	...
	<div class="card-deck">
				...
				<p class="card-text">
					<div class="input-group input-group-lg w-50 mx-auto">
						<div class="input-group-prepend">
							<button class="btn btn-outline-light" id="likebutton"><i class="fa fa-thumbs-up"></i></button>
						</div>
		...
		<div class="card mb-3 bg-warning">
			<div class="card-body text-center">
				...
				<p class="card-text">A lot of new tools are currently being developed; please use the sugesstion Contact Us page to make suggestions and report bugs!</p>	
			</div>
		</div>
		...
		<div class="card mb-3 text-white bg-info">
			<div class="card-body text-center">
				...
				<h2 class="card-text"><a class="text-white" href="https://discord.gg/rufp9hw">--><u>ATC-Com</u><--</a></h2>
