<?php $page='metar'; $title='METAR Decoder'; include '../assets/layout/header.php'; ?>
	...
	<div class="col-md-5 pb-4">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<p class="card-text">This tool has been adapted from the original METAR Decoder JavaScript program from <a href="http://heras-gilsanz.com/manuel/index.html">Manuel Heras</a>.</p>
				...
				<p class="card-text">
					If you see something in a METAR which you do not understand, you should consult a key of METAR parameters, or ask someone who will know.<br>Wikipedia provides basic <a href="https://en.wikipedia.org/wiki/METAR#International_METAR_codes">information on METAR parameters</a> which you can use.
				</p>
